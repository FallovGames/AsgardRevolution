...
import l2ar.commons.dbutils.DbUtils;
import l2ar.gameserver.cache.Msg;
import l2ar.gameserver.data.xml.holder.VariationGroupHolder;
import l2ar.gameserver.database.DatabaseFactory;
import l2ar.gameserver.listener.script.OnInitScriptListener;
import l2ar.gameserver.model.Player;
import l2ar.gameserver.model.actor.instances.player.ShortCut;
...
import l2ar.gameserver.network.lineage2.serverpackets.ActionFail;
import l2ar.gameserver.network.lineage2.serverpackets.InventoryUpdate;
import l2ar.gameserver.network.lineage2.serverpackets.ShortCutRegister;
import l2ar.gameserver.scripts.Functions;
import l2ar.gameserver.templates.item.ItemTemplate;
import l2ar.gameserver.templates.item.support.VariationGroupData;
