...
import l2ar.gameserver.cache.HtmCache;
import l2ar.gameserver.handler.admincommands.impl.AdminEditChar;
import l2ar.gameserver.model.AggroList.HateComparator;
import l2ar.gameserver.model.AggroList.HateInfo;
import l2ar.gameserver.model.*;
import l2ar.gameserver.model.base.Element;
import l2ar.gameserver.model.entity.events.GlobalEvent;
import l2ar.gameserver.model.instances.DoorInstance;
import l2ar.gameserver.model.instances.NpcInstance;
import l2ar.gameserver.model.instances.PetInstance;
...
import l2ar.gameserver.templates.spawn.SpawnTemplate;
import l2ar.gameserver.utils.HtmlUtils;
...
public class OnActionShift extends Functions {
    public boolean OnActionShift_NpcInstance(final Player player, final GameObject object) {
        ...
        if (object.isNpc()) {
            ...
            if (Config.ALT_FULL_NPC_STATS_PAGE) {
                dialog = HtmCache.getInstance().getNotNull("scripts/actions/player.L2NpcInstance.onActionShil2ar.full.htm", player);
                ...
                dialog = HtmCache.getInstance().getNotNull("scripts/actions/player.L2NpcInstance.onActionShil2ar.htm", player);
            }
    ...
    public boolean OnActionShift_DoorInstance(final Player player, final GameObject object) {
        ...
        String dialog = HtmCache.getInstance().getNotNull("scripts/actions/admin.L2DoorInstance.onActionShil2ar.htm", player);
    ...
    public boolean OnActionShift_PetInstance(final Player player, final GameObject object) {
        ...
        if (object.isPet()) {
            ...
            String dialog = HtmCache.getInstance().getNotNull("scripts/actions/admin.L2PetInstance.onActionShil2ar.htm", player);
    ...
    public boolean OnActionShift_ItemInstance(final Player player, final GameObject object) {
        ...
        if (object.isItem()) {
            ...
            String dialog = HtmCache.getInstance().getNotNull("scripts/actions/admin.L2ItemInstance.onActionShil2ar.htm", player);
